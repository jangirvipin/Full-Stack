...
export default function Navbar() {
    ...
    return (
        <>
        <div className={`max-w-screen-2xl dark:bg-slate-800 dark:text-white container z-50 mx-auto md:px-20 px-4 fixed top-0 right-0 left-0
  ...
  <div className="navbar-start">
    ...
    <a className=" text-3xl font-bold">BookStore</a>
  </div>
  ...
  <div className="">
    <a className="bg-black px-5 lg:py-3 py-2  rounded-md text-white hover:bg-slate-800 duration-300 cursor-pointer"
